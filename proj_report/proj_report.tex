...
%% article.
\begin{abstract}
Project repository: \url{https://git.cs.vt.edu/bug19/cs4974_independent_study}
\end{abstract}
...
\subsection{Phase 1: Assembler}
\begin{center}
\begin{tabular}{| c | c | c |}
    \hline
    Week \# & Topic & Reading\\
    \hline
    1 & Instruction set and assembly framework & Varanese Chapter 8\\
    2 & lexer, state machine, and regular expressions & Nystrom Chapter 4\\
    4 & Top-down parsing & Varanese Chapter 15\\
    3 & Instruction and operand parsing & Varanese Chapter 9\\
    5 & Forward referencing and code generation & Varanese Chapter 9\\
    \hline
\end{tabular}
\end{center}

\subsection{Phase 2: Virtual Machine}
\begin{center}
\begin{tabular}{| c | c | c |}
    \hline
    Week \# & Topic & Reading\\
    \hline
    6 & Runtime stack interface & Varanese Chapter 10\\
    7 & Operand type resolution and coercion & Nystrom Chapter 10\\
    8 & VM execution cycle & Varanese Chapter 11\\
    \hline
\end{tabular}
\end{center}

\subsection{Phase 3: Compiler}
\begin{center}
\begin{tabular}{| c | c | c |}
    \hline
    Week \# & Topic & Reading\\
    \hline
    9 & Loader, preprocessor, and lexical analysis & Varanese Chapter 12, Nystrom Chapter 4\\
    10 & Abstract syntax tree and parsing expressions/statements & Nystrom Chapter 5-6\\
    11 & Semantic analysis and code emission using Visitor pattern & Nystrom Chapter 7-8, 11\\
    12 & Control flow & Nystrom Chapter 9\\
    13 & Functions, pass-by-reference & Nystrom 10\\
    \hline
\end{tabular}
\end{center}

\subsection{Phase 4: Wrap-up}
\begin{center}
\begin{tabular}{| c | c | c |}
    \hline
    Week \# & Topic & Reading\\
    \hline
    14 & Demo & \\
    15 & Project report and end of semester discussion & ACM Conference Article Template \\
    \hline
\end{tabular}
\end{center}
...
As a solution, the parser was designed to use the recursive descent technique. The following BNF describes the expression grammar rules of the custom language. \autoref{grammar rules: expressions}
...
\end{tabular}
\end{center}
\caption{Grammar rules: expressions}
\label{grammar rules: expressions}
\end{figure}
...
The above grammar rules were translated directly to the C++ functions using the following strategy: \autoref{grammar rules to implementation}
...
\end{tabular}
\end{center}
\caption{Grammar rules to implementation}
\label{grammar rules to implementation}
\end{figure}
