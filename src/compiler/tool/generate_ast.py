...
def defineAst (output_dir, base_name, types):
  ...
  output.write ("class Visitor;\n")
  output.write ("\n")
  output.write ("class " + base_name + "\n")
  output.write ("{\n")
  output.write ("};\n")
  output.write ("\n")
...
def defineType (output, base_name, class_name, fields):
  output.write ("class " + class_name + " : public " + base_name + "\n")
  output.write ("{\n")
  # constructor
  ...
  output.write ("\n")
  output.write ("  template <typename T>\n")
  output.write ("  T accept (Visitor<T> visitor)\n")
  output.write ("  {\n")
...
def defineVisitor (output, base_name, types):
  ...
  for elem in types:
    ...
    output.write ("  virtual T visit" + type_name + base_name + " (" + \
